...
public class StackCheckBalancedParentheses {
	...
	/**
	 * Default constructor for class StackCheckBalancedParentheses
	 */
	public StackCheckBalancedParentheses() {
		
	}
	
	/**
	 * Overloaded constructor for class QueueCheckBalancedParentheses
	 * @param userText Input string from the user
	 */
	public StackCheckBalancedParentheses(String userText) {
		setText(userText);
	}
